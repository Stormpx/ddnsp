...
public interface Errno {
    ...
    int EDEADLK = 35; // 	Resource deadlock avoided
    int ENAMETOOLONG = 36; // 	File name too long
    int ENOLCK = 37; // 	No locks available
    int ENOSYS = 38; // 	Function not implemented
    int ENOTEMPTY = 39; // 	Directory not empty
    int ELOOP = 40; // 	Too many levels of symbolic links
    ...
    int EILSEQ = 84; // 	Invalid or incomplete multibyte or wide character
    ...
    int EOPNOTSUPP = 95; // 	Operation not supported
    ...
    int ENETRESET = 102; // 	Network dropped connection on reset
    ...
    int ESTALE = 116; // 	Stale file handle
    ...
    int EDQUOT = 122; // 	Disk quota exceeded
    ...
    int ERFKILL = 132; // 	Operation not possible due to RF-kill
    int EHWPOISON = 133; // 	Memory page has hardware error
    int ENOTSUP = 134; // 	Not supported parameter or option
    int ESTRPIPE0 = 143; // 	Streams pipe error
